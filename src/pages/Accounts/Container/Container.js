      ...
      <div className={cx('center')}>
        ...
        <div className={cx('header')}>
          ...
          {form ? (
            ...
            <h2 className={cx('heading')}>Đăng ký tài khoản JobCare</h2>
          )}
        </div>
        ...
        {isFormVisible === false ? (
          <div className={cx('content')}>
            ...
            >
              ...
              <span className={cx('option-title')}>Sử dụng Email</span>
            </div>
            ...
            <div className={cx('form-option')}>
              ...
              <span className={cx('option-title')}>Tiếp tục với Google</span>
            </div>
          </div>
        ) : (
          <Form form={form} />
        ...
        {form ? (
          <div className={cx('dont-have-account')}>
            ...
            {form && isFormVisible ? (
              <div className={cx('change-form-btn')}>Quên mật khẩu?</div>
            ) : (
              ''
            )}
          </div>
